...
import { instancePool } from './instance_pool.js';
/**
 * Convert a markdown task to JSON
 * Uses the instance pool to execute the conversion
 */
export async function convertTaskMarkdown(params) {
...
export async function executeTask(params) {
    ...
    `;
        ...
        instancePool.executeTask(backgroundTaskId, taskPrompt, {
 ...
 */
export async function taskStatus(params) {
    const { taskId } = params;
    try {
